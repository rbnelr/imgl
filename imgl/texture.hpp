...
namespace gl_texture {
	...
	public:
		...
		// auto free texture
		~Texture2D () {
			if (gpu_handle) // maybe this helps to optimize out destructing of unalloced textures
				glDeleteTextures(1, &gpu_handle); // would be ok to delete unalloced texture (gpu_handle = 0)
		}
